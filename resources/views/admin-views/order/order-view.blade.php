                                                ...
                                                @if($order['order_status']=='out_for_delivery')
                                                    ...
                                                    @if(isset($origin))
                                                        <a class="btn btn-outline-primary" target="_blank"
                                                           title="{{translate('Earrand Guy Last Location')}}" data-toggle="tooltip" data-placement="top"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title fs-5" id="assignDeliveryManLabel">{{translate('Assign_Earrand_Guy_Man')}}</h4>
        ...
        function addDeliveryMan(id) {
            $.ajax({
                ...
                success: function (data) {
                    if(data.status == true) {
                        toastr.success('{{\App\CentralLogics\translate("Earrand Guy successfully assigned/changed")}}', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function () {

                    ...
                    <form action="#" id="form-data" method="GET">
                        <div class="row gy-3 gx-2 align-items-end">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <label for="select_branch">{{translate('Select_Restarant')}}</label>
                                <!-- Select -->
                                <select class="form-control" name="branch" onchange="filter_branch_orders(this.value)" id="select_branch">
                                    <option disabled selected>--- {{translate('select')}} {{translate('Restarant')}} ---</option>
                                    <option value="0" {{session('branch_filter')==0?'selected':''}}>{{translate('all')}} {{translate('Restarant')}}</option>

...
@section('title', translate('Update Restaurant'))
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$branch['outdoor_slots']}}" type="number" name="outdoor_slots" class="form-control" placeholder="Outdoor slots" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="input-label" for="">{{translate('Indoor Slots')}}</label>
                                        <input value="{{$branch['indoor_slots']}}" type="number" name="indoor_slots" class="form-control" placeholder="indoor slots" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('continent')}}" type="text" value="{{$branch['continent']}}" name="continent" class="form-control"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="physical_address" class="form-control" value="{{$branch['physical_address']}}" placeholder="{{translate('physical_address')}}" required>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="input-label">{{translate('city')}}</label>
                                        <input value="{{old('city')}}" type="tel" name="city" value="{{$branch['city']}}" class="form-control"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('state')}}" type="text" name="state" value="{{$branch['state']}}" class="form-control"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="zip_code" class="form-control" value="{{$branch['zip_code']}}" placeholder="{{translate('zip_code')}}" required>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
...
@push('script_2')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key={{ \App\Model\BusinessSetting::where('key', 'map_api_key')->where('branch_id',auth('admin')->id())->first()->value }}&libraries=places&v=3.45.8"></script>

...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('admin.rpackage.update',[$package['id']])}}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title"
                                        placeholder="{{translate('Ex')}} : {{translate('Permium')}}" value="{{$package['name']}}" required>
                                </div>
                            </div>

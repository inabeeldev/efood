...
@section('title', translate('Restaurants Package List'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{route('admin.rpackage.update',[$package['id']])}}"
                                        ...
                                        <form action="{{route('admin.rpackage.delete')}}" method="post" id="package-{{$package->id}}">
                                            @csrf
                                            @method('DELETE')

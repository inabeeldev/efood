                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        <div class="hs-unfold">
                            <div class="bg-white p-1 rounded">
                                ...
                                @php($lang = \App\CentralLogics\Helpers::get_branch_business_settings('language')??null)
                                <?php
                                    // print_r(json_encode($lang));
                                ?>
...
{{--                                    @dump(auth('branch')->user())--}}
                                    ...
                                    <span class="card-text fz-12 font-weight-bold">{{translate('Restaurant Admin')}}</span>
                                </div>

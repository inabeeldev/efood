        ...
        <div class="navbar-vertical-container text-capitalize">
            <div class="navbar-vertical-footer-offset">
                <div class="navbar-brand-wrapper justify-content-between">
                    <!-- Logo -->
                    @php
                    $restaurant_logo = \App\Model\BusinessSetting::where(['key' => 'logo', 'branch_id' => auth('admin')->id()])->first();
                    $restaurant_logo_value = $restaurant_logo ? $restaurant_logo->value : null;
                    @endphp
                        ...
                        {{-- @if(Helpers::module_permission_check(MANAGEMENT_SECTION['promotion_management'])) --}}
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/notification*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('admin.notification.add-new')}}">
                                    ...
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{translate('send')}} {{translate('Emergency Alerts')}}
...
{{--                                            <i class="tio-chart-bar-3 nav-icon"></i>--}}
                                            ...
                                            <span
                                                class="text-truncate">{{translate('Earrand Report')}}</span>
                                        </a>
                                    </li>
                        ...
                        {{-- @if(Helpers::module_permission_check(MANAGEMENT_SECTION['user_management'])) --}}
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/customer/transaction') || Request::is('admin/customer/list') || Request::is('admin/customer/view*')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('admin/customer/transaction') || Request::is('admin/customer/list')  || Request::is('admin/customer/view*')?'block':''}}; top: 831.076px;">
                                    ...
                                    <li class="nav-item {{Request::is('admin/customer/customer-incentives')? 'active':''}}">
                                        <a class="nav-link" href="{{route('admin.customer.customer-incentives')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('Customer Incentives')}}</span>
                                        </a>
                                    </li>
...
{{--                            </li>--}}
                        ...
                        {{-- @if(Helpers::module_permission_check(MANAGEMENT_SECTION['user_management'])) --}}
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/rpackage*') || Request::is('admin/rpackage*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{translate('membership')}}">
                                    <i class="tio-incognito nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{translate('Rrestaurant Packages')}}
                                        </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub " style="display: {{Request::is('admin/rpackage*') || Request::is('admin/rpackage*')?'block':''}}">

                                    <li class="nav-item {{Request::is('admin/rpackage/add-new')? 'active': ''}}">
                                        <a class="nav-link" href="{{route('admin.rpackage.add-new')}}" title="{{translate('app_package')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                    {{translate('add_package')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/package/list')? 'active': ''}}">
                                        <a class="nav-link" href="{{route('admin.rpackage.list')}}" title="{{translate('list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                    {{translate('list')}}</span>
                                        </a>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/package*') || Request::is('admin/package*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{translate('membership')}}">
                                    <i class="tio-incognito nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{translate('Packages')}}
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub " style="display: {{Request::is('admin/package*') || Request::is('admin/package*')?'block':''}}">

                                    <li class="nav-item {{Request::is('admin/package/add-new')? 'active': ''}}">
                                        <a class="nav-link" href="{{route('admin.package.add-new')}}" title="{{translate('app_package')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                    {{translate('add_package')}}</span>
                                        </a>
                                    ...
                                    <li class="nav-item {{Request::is('admin/package/list')? 'active': ''}}">
                                        <a class="nav-link" href="{{route('admin.package.list')}}" title="{{translate('list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                    {{translate('list')}}</span>
                                        </a>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/membership*') || Request::is('admin/membership*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{translate('membership')}}">
                                    <i class="tio-incognito nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub " style="display: {{Request::is('admin/membership*') || Request::is('admin/membership*')?'block':''}}">
                                    <li class="nav-item {{Request::is('admin/membership/list')? 'active': ''}}">
                                        <a class="nav-link" href="{{route('admin.membership.list')}}" title="{{translate('list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                    {{translate('list')}}</span>
                                        </a>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/reservation*') || Request::is('admin/reservation*')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub " style="display: {{Request::is('admin/reservation*') || Request::is('admin/reservation*')?'block':''}}">
                                    <li class="nav-item {{Request::is('admin/reservation/list')? 'active': ''}}">
                                        <a class="nav-link" href="{{route('admin.reservation.list')}}" title="{{translate('list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                    {{translate('list')}}</span>
                                        </a>

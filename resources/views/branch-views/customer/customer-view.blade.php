        ...
        <div class="d-print-none pb-2">
            ...
            <div class="d-flex flex-wrap gap-3 justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex flex-wrap gap-3 justify-content-lg-end">
                    ...
                    <a class="btn btn-primary" href="{{ route('branch.customer.customer_transaction',[$customer['id']]) }}">
                        ...
                        <div class="card-body">
                            <div class="media gap-3">
                                ...
                                <div class="media-body d-flex flex-column gap-1">
                                    <div class="text-dark d-flex gap-2 align-items-center"><span class="tio-email"></span> <a class="text-dark" href="mailto:{{$customer['email']}}">{{"**********"}}</a></div>
                                    <div class="text-dark d-flex gap-2 align-items-center"><span class="tio-call-talking-quiet"></span> <a class="text-dark" href="tel:{{$customer['phone']}}">{{"**********"}}</a></div>
    ...
    <div class="modal fade point-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('branch.customer.AddPoint',[$customer['id']])}}" method="post">
                    @csrf

                    ...
                    <div class="card-top px-card pt-4">
                        <div class="row justify-content-between align-items-center gy-2">
                            ...
                            <div class="col-sm-8 col-md-6 col-lg-4">
                                <form action="{{route('branch.reviews.search')}}" method="post" id="search-form" onsubmit="event.preventDefault()">
                                    @csrf
                                ...
                                @foreach($reviews as $key=>$review)
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                @if($review->product)
                                                    <a class="text-dark media align-items-center gap-2" href="{{route('branch.product.view',[$review['product_id']])}}">
                                                        <div class="avatar">
...
@push('script_2')
    <script>
        $('#search-form').on('submit', function () {
            ...
            $.post({
                url: '{{route('branch.reviews.search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,

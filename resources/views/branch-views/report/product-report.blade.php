                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                            <div class="">
                                ...
                                <div class="">
                                    ...
                                    <a href="#">{{auth('branch')->user()->f_name.' '.auth('branch')->user()->l_name}}</a>
                                </div>
                            </div>

                            <div class="d-flex">
                                <a class="btn btn-icon btn-primary px-2 rounded-circle" href="{{route('branch.dashboard')}}">
                        ...
                        <div class="col-md-6 d-flex justify-content-md-end">
                            {{-- <div>
                                <a class="js-hs-unfold-invoker btn btn-sm btn-white"
                                    href="{{route('branch.report.export-product-report')}}" target="_blank">
...
@push('script_2')
    <script>
        ...
        function filter_branch_orders(id) {
            location.href = '{{url('/')}}/branch/orders/branch-filter/' + id;
        }
    </script>
    ...
    <script>
        $('#search-form').on('submit', function () {
            $.post({
                url: "{{route('branch.report.product-report-filter')}}",

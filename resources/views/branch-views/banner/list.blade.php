        ...
        <div class="content">
            ...
            <div class="row g-2">
                <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                    <form action="{{route('branch.banner.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group" id="type-category" style="display: none">
                                            ...
                                            <select name="category_id" class="custom-select js-select2-custom">
                                                ...
                                                @foreach(\App\Model\Category::where('parent_id', 0)->where('branch_id',auth('branch')->id())->get() as $category)
                                        ...
                                        <td>
                                            <label class="switcher">
                                                <input class="switcher_input" type="checkbox" {{$banner['status']==1 ? 'checked' : ''}} id="{{$banner['id']}}"
                                                    data-url="{{route('branch.banner.status',[$banner['id'],0])}}" onchange="status_change(this)"
                                                >
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                <a class="btn btn-outline-info btn-sm edit square-btn"
                                                    href="{{route('branch.banner.edit',[$banner['id']])}}"><i class="tio-edit"></i></a>

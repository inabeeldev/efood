                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="switcher">
                                                <input id="{{$coupon['id']}}" class="switcher_input" type="checkbox" onchange="status_change(this)" {{$coupon['status']==1? 'checked': '' }}
                                                    data-url="{{route('branch.coupon.status',[$coupon['id'],1])}}"
                                                >
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                href="{{route('branch.coupon.update',[$coupon['id']])}}"><i class="tio-edit"></i></a>
                                            ...
                                            <form action="{{route('branch.coupon.delete',[$coupon['id']])}}"
...
@push('script_2')
    ...
    <script>
        function generateCode() {
            $.get('{{route('branch.coupon.generate-coupon-code')}}', function (data) {
    ...
    <script>
        ...
        function modalShow(t) {
            let couponId = t.id;
            let targetUrl = "{{route('branch.coupon.coupon-details')}}" + "?id=" + couponId;
            $.ajax({
                url: targetUrl,
                type: 'GET',

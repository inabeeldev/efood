...
@section('title', translate('Earrand Guy List'))
                            ...
                            <div class="d-flex flex-wrap justify-content-md-end gap-3">
                                <div>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a type="submit" class="dropdown-item d-flex align-items-center gap-2" href="{{route('branch.delivery-man.excel-export')}}">
                                 ...
                                 <a href="{{route('branch.delivery-man.add')}}" class="btn btn-primary">
                                    <i class="tio-add"></i>
                                    {{translate('add_Earrand_Guy')}}
                                </a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="switcher">
                                                <input id="{{$dm['id']}}" type="checkbox" class="switcher_input" {{$dm['is_active'] == 1? 'checked' : ''}}
                                                       data-url="{{route('branch.delivery-man.ajax-is-active', ['id'=>$dm['id']])}}" onchange="status_change(this)"
                                                >
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-3">
                                                ...
                                                href="{{route('branch.delivery-man.edit',[$dm['id']])}}"><i class="tio-edit"></i></a>
                                            ...
                                            <form action="{{route('branch.delivery-man.delete',[$dm['id']])}}"
...
@push('script_2')
    <script>
        $('#search-form').on('submit', function () {
            ...
            $.post({
                url: '{{route('branch.delivery-man.search')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,

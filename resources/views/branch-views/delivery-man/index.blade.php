...
@section('title', translate('Add new Earrand_Guy'))
...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row g-2">
            <div class="col-12">
                <form action="{{route('branch.delivery-man.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>{{translate('Earrand_Guy_Image')}}</label>

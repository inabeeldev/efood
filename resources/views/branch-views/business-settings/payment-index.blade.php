...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Inine Page Menu -->
        @include('branch-views.business-settings.partials._3rdparty-inline-menu')
        ...
        <div class="row g-2">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('branch.business-settings.web-app.payment-method-update',['cash_on_delivery'])}}"
                              method="post">
                            @csrf
                            @if(isset($config))
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('branch.business-settings.web-app.payment-method-update',['digital_payment'])}}"
                              method="post">
                            @csrf
                            @if(isset($config))
                                <div class="form-group mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form
                        action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.payment-method-update',['ssl_commerz_payment']):'javascript:'}}"
                        method="post">
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form
                        action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.payment-method-update',['razor_pay']):'javascript:'}}"
                        method="post">
                        @csrf
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form
                        action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.payment-method-update',['paypal']):'javascript:'}}"
                        method="post">
                        @csrf
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form
                        action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.payment-method-update',['stripe']):'javascript:'}}"
                        method="post">
                        @csrf
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form
                        action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.payment-method-update',['paystack']):'javascript:'}}"
                        method="post">
                        @csrf
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form
                        action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.payment-method-update',['senang_pay']):'javascript:'}}"
                        method="post">
                        @csrf
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form action="{{route('branch.business-settings.web-app.payment-method-update',['internal_point'])}}"
                          method="post">
                        @csrf
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form
                        action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.payment-method-update',['bkash']):'javascript:'}}"
                        method="post">
                        @csrf
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form
                        action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.payment-method-update',['paymob']):'javascript:'}}"
                        method="post">
                        @csrf
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form
                        action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.payment-method-update',['flutterwave']):'javascript:'}}"
                        method="post">
                        @csrf
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form
                        action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.payment-method-update',['mercadopago']):'javascript:'}}"
                        method="post">
                        @csrf
                    <div class="card-body">
                        <div class="d-flex justify-content-between">

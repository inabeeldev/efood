            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.sms-module-update',['twilio_sms']):'javascript:'}}"
                              method="post">
                            @csrf
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <form action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.sms-module-update',['2factor_sms']):'javascript:'}}"
                              method="post">
                            @csrf
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <form action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.sms-module-update',['signalwire_sms']):'javascript:'}}"
                              method="post">
                            @csrf
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.sms-module-update',['nexmo_sms']):'javascript:'}}"
                              method="post">
                            @csrf
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <form action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.sms-module-update',['msg91_sms']):'javascript:'}}"
                              method="post">
                            @csrf

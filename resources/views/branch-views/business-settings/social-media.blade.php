...
@push('script')
    ...
    <script>
        ...
        function fetch_social_media() {
            ...
            $.ajax({
                url: "{{route('branch.business-settings.web-app.third-party.fetch')}}",
                method: 'GET',
        ...
        $('#add').on('click', function () {
            ...
            $.ajax({
                url: "{{route('branch.business-settings.web-app.third-party.social-media-store')}}",
                method: 'POST',
                data: {
                    name: name,
                    link: link
        ...
        $('#update').on('click', function () {
            ...
            $.ajax({
                url: "{{route('branch.business-settings.web-app.third-party.social-media-update')}}",
                method: 'POST',
                data: {
                    id: id,
                    name: name,
        ...
        $(document).on('click', '.delete', function () {
            ...
            if (confirm("{{translate('Are you sure delete this social media')}}?")) {
                ...
                $.ajax({
                    url: "{{route('branch.business-settings.web-app.third-party.social-media-delete')}}",
                    method: 'POST',
                    data: {id: id},
                    success: function (data) {
                        fetch_social_media();
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                url: "{{route('branch.business-settings.web-app.third-party.social-media-edit')}}",
                method: 'POST',
                data: {id: id},
                success: function (data) {
                    $(window).scrollTop(0);
        ...
        $(document).on('change', '.status', function () {
            ...
            $.ajax({
                url: "{{route('branch.business-settings.web-app.third-party.social-media-status-update')}}",
                method: 'POST',
                data: {
                    id: id,
                    status: status
    ...
    <script>
        function status_change_sm(t) {
            console.log(t.id)
            let url = "{{route('branch.business-settings.web-app.third-party.social-media-status-update')}}" + "?id=" + t.id;
            console.log(url)

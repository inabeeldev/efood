    ...
    <div class="content container-fluid">
        ...
        <div class="row g-2">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.third-party.update-fcm'):'javascript:'}}" method="post"
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('branch.business-settings.update-fcm-messages')}}" method="post"
                              enctype="multipart/form-data">
                            @csrf

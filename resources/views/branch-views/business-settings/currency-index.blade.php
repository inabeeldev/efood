    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('branch.business-settings.currency-add')}}" method="post"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if($currency['currency_code']!='USD')
                                            <a class="dropdown-item"
                                               href="{{route('branch.business-settings.currency-update',[$currency['id']])}}">{{translate('Edit')}}</a>
                                            <a class="dropdown-item" href="javascript:"
                                               onclick="$('#currency-{{$currency['id']}}').submit()">{{translate('Delete')}}</a>
                                            <form
                                                action="{{route('branch.business-settings.currency-delete',[$currency['id']])}}"

        ...
        <div class="d-flex flex-wrap align-items-center gap-4 gap-sm-2 gapx-30">
            @foreach ($data['1'] as $day)
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <div class="badge badge-danger rounded-circle cursor-pointer" onclick="delete_schedule('{{route('branch.business-settings.restaurant.time_schedule_remove',['schedule_id'=>$day['id']])}}')">X</div>
                </div>
            @endforeach
        </div>
        @else

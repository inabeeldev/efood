...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Inline Menu -->
        @include('branch-views.business-settings.partials._system-settings-inline-menu')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="card mb-3" action="{{route('branch.business-settings.web-app.system-setup.language.add-new')}}" method="post"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="switcher">
                                                    <input type="checkbox"
                                                           onclick="updateStatus('{{route('branch.business-settings.web-app.system-setup.language.update-status')}}','{{$data['code']}}','{{$data['default']}}')"
                                            ...
                                            <td>
                                                <label class="switcher">
                                                    <input type="checkbox"
                                                           onclick="window.location.href ='{{route('branch.business-settings.web-app.system-setup.language.update-default-status', ['code'=>$data['code']])}}'"
                                            ...
                                            <td class="">
                                                <div class="d-flex justify-content-start align-items-center gap-2 flex-wrap">
                                                    ...
                                                    href="{{route('branch.business-settings.web-app.system-setup.language.translate',[$data['code']])}}">{{translate('Translate')}}</a>
                                                    @if($data['code']!='en')
                                                        ...
                                                        @if($data['default'] != true)
                                                            <button class="btn btn-sm btn-outline-primary px-3" id="delete"
                                                                onclick="delete_language('{{ route('branch.business-settings.web-app.system-setup.language.delete',[$data['code']]) }}')">
                ...
                <div class="modal fade" id="lang-modal-update-{{$data['code']}}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('branch.business-settings.web-app.system-setup.language.update')}}" method="post">
                                @csrf

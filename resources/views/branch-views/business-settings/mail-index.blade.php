...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row g-2">
            ...
            <div class="col-12">
                <form action="{{env('APP_MODE')!='demo'?route('branch.business-settings.web-app.mail-config'):'javascript:'}}" method="post"
            ...
            if (ValidateEmail($('#test-email').val())) {
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{route('branch.business-settings.web-app.mail-send')}}",
                            method: 'POST',
                            data: {

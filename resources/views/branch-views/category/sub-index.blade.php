                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            @foreach(\App\Model\Category::where(['position'=>0,'branch_id'=>auth('branch')->id()])->get() as $category)
                                        ...
                                        <td>
                                                ...
                                                <div>
                                                    <label class="switcher">
                                                        ...
                                                        onchange="status_change(this)" data-url="{{route('branch.category.status',[$category['id'],1])}}"
                                                        >
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                <a class="btn btn-outline-info btn-sm edit square-btn"
                                                    href="{{route('branch.category.edit',[$category['id']])}}">
                                                    <i class="tio-edit"></i>
                                                </a>

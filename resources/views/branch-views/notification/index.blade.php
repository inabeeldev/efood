...
@section('title', translate('Emergency Alert'))
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                ...
                <span class="page-header-title">
                    {{translate('send_Emergency_Alerts')}}
                </span>
            </h2>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                ...
                                <button type="submit" class="btn btn-primary">{{translate('send_alert')}}</button>
                            </div>
                        </div>
                    </div>
                </form>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="switcher">
                                                <input class="switcher_input" type="checkbox" onclick="status_change(this)" id="{{$notification['id']}}"
                                                    data-url="{{route('branch.notification.status',[$notification['id'],0])}}" {{$notification['status'] == 1? 'checked' : ''}}>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                href="{{route('branch.notification.edit',[$notification['id']])}}"><i class="tio-edit"></i></a>
                                            ...
                                            <form
                                                action="{{route('branch.notification.delete',[$notification['id']])}}"

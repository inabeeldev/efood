                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media align-items-center gap-3">
                                                ...
                                                <div class="media-body">
                                                    <a class="text-dark" href="{{route('branch.product.view',[$product['id']])}}">
                                        ...
                                        <td>
                                            <div>
                                                <label class="switcher">
                                                    <input id="{{$product['id']}}" class="switcher_input" type="checkbox" {{$product['status']==1? 'checked' : ''}} data-url="{{route('branch.product.status',[$product['id'],0])}}" onchange="status_change(this)">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                href="{{route('branch.product.edit',[$product['id']])}}"><i class="tio-edit"></i></a>

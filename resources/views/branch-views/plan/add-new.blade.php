...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('branch.package.add-new')}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title"
                                        placeholder="{{translate('Ex')}} : {{translate('Permium')}}" value="{{old('title')}}" required>
                                </div>
                            </div>
                            {{-- <div class="col-md-4">
                                <div class="form-group">
                                    <label for="price">{{translate('promo_price')}}</label>
                                    <input type="number" name="promo_price" value="{{old('promo_price')}}" class="form-control" id="promo_price"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order_limit" value="{{old('order_limit')}}" class="form-control" id="order_limit"
                                        placeholder="{{translate('Ex')}} : 1" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="trial_period" value="{{old('trial_period')}}" class="form-control" id="trial_period"
                                        placeholder="{{translate('Ex')}} : 1" required>
                                </div>
                            </div>

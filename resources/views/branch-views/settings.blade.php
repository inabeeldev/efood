        ...
        <div class="row">
                        ...
                        <ul id="navbarSettings"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:" id="addressSection">
                                    <i class="tio-lock-outlined nav-icon"></i> {{ translate('Address') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:" id="locationSection">
                                    <i class="tio-user nav-icon"></i> {{ translate('Location') }}
                                </a>
                            </li>
                        </ul>
                        <!-- End Navbar Nav -->
            ...
            <div class="col-lg-9">
                ...
                <!-- Card -->
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel" class="col-sm-3 col-form-label input-label">{{ translate('Restaurant name') }} <i
                    ...
                    <div class="card mb-3 mb-lg-5">
                        <div class="card-header">
                            <h2 class="card-title h4"><i class="tio-info"></i> {{ translate('Address Settings') }}</h2>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" value="{{auth('branch')->user()->continent ?? ''}}" name="continent" class="form-control"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="physical_address" class="form-control"  value="{{auth('branch')->user()->physical_address ?? ''}}"  placeholder="{{translate('physical_address')}}" required>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="input-label">{{translate('city')}}</label>
                                        <input  name="city" value="{{auth('branch')->user()->city ?? ''}}"  class="form-control"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="state" value="{{auth('branch')->user()->state ?? ''}}"   class="form-control"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="zip_code" class="form-control" value="{{auth('branch')->user()->zip_code ?? ''}}"   placeholder="{{translate('zip_code')}}" required>
                                    </div>
                                </div>
                                </div>
                ...
                <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="row g-3">
                                        <form id="changeLocationForm" action="{{env('APP_MODE')!='demo'?route('branch.settings-location'):'javascript:'}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" step="any" id="latitude" name="latitude" class="form-control"
                                                       ...
                                                       value="{{auth('branch')->user()->latitude ?? ''}}" required >
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" step="any" name="longitude" class="form-control"
                                                       ...
                                                       value="{{auth('branch')->user()->longitude ?? ''}}" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" name="coverage" min="1" max="1000" class="form-control" placeholder="{{ translate('Ex : 3') }}" value="{{auth('branch')->user()->coverage ?? ''}}" required>
                                            </div>
                                        </div>
                                        </form>
                                    </div>
                                ...
                                <div class="col-md-8" id="location_map_div">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('changeLocationForm','".translate("Want to update location ?")."')":"call_demo()"}}" class="btn btn-primary">{{ translate('Save Changes') }}</button>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    <script>
        ...
        $("#locationSection").click(function() {
            $("#generalSection").removeClass("active");
            $("#passwordSection").removeClass("active");
        ...
        $( document ).ready(function() {
            function initAutocomplete() {
                var myLatLng = {
                    ...
                    lat: {{auth('branch')->user()->latitude ?  auth('branch')->user()->latitude : '23.811842872190343'}} ,
                    lng: {{auth('branch')->user()->longitude ? auth('branch')->user()->longitude : '90.356331'}} 
                };
         ...
         $(document).on('ready', function () {
            @php($country=auth('branch')->user()->country ??'BD')

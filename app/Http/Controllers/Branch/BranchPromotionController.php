...
class BranchPromotionController extends Controller
{
    public function create(Request $request)
    {
        ...
        return view('branch-views.branch_promotion.create', compact('branches', 'search', 'promotions'));
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('branch-views.branch_promotion.edit', compact('promotion', 'branches'));
    }
    ...
    public function branch_wise_list(Request $request)
    {
        ...
        return view('branch-views.branch_promotion.branch_wise_list', compact( 'search', 'promotions', 'branch'));
    }

...
class PackageController extends Controller
{
    public function add_new()
    {
        ...
        return view('branch-views.plan.add-new', compact('rls'));
    }

    public function list(Request $request){
        $search = $request['search'];
        $key = explode(' ', $request['search']);
        $packages = BranchPlan::when($search!=null, function($query) use($key){
        ...
        return view('branch-views.plan.list', compact('packages','search'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('branch.package.list');
    }

    public function edit($id)
    {
        $package = BranchPlan::where(['id' => $id])->first();
        return view('branch-views.plan.edit', compact('package'));
    }
    ...
    {
        $action = BranchPlan::destroy($request->id);
        if ($action) {

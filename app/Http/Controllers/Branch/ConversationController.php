...
class ConversationController extends Controller
{
    public function list()
    {
        ...
        ->where('conversations.restaurant_id',auth('branch')->id())
    ...
    public function view($user_id)
    {
        ...
        return response()->json([
            'view' => view('branch-views.messages.partials._conversations', compact('convs', 'user'))->render()
        ]);
    }

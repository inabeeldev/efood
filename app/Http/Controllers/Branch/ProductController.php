...
class ProductController extends Controller
{
    ...
    {
        $cat = Category::where(['parent_id' => $request->parent_id,'branch_id' => auth('branch')->id()])->get();
    ...
    {
        $categories = Category::where(['position' => 0,'branch_id'=>auth('branch')->id()])->get();
    ...
    public function list(Request $request)
    {
        ...
        $products = $query->where(['branch_id' => auth('branch')->id()])->orderBy('id', 'DESC')->paginate(Helpers::getPagination())->appends($query_param);
    ...
    {
        $product = Product::where(['id' => $id,'branch_id' => auth('branch')->id()])->first();
...
//        dd($request);
        ...
        $product->branch_id = auth('branch')->id();
    ...
    public function edit($id)
    {
        ...
        $categories = Category::where(['parent_id' => 0,'branch_id' => auth('branch')->id()])->get();
    ...
    {
        return view('branch-views.product.bulk-export');
    }
}

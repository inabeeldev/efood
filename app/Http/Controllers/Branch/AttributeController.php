...
class AttributeController extends Controller
{
    function index(Request $request)
    {
        ...
        $attributes = $attributes->where('branch_id',auth('branch')->id())->orderBy('name')->paginate(Helpers::getPagination())->appends($query_param);
    ...
    public function store(Request $request)
    {
        ...
        $attribute->branch_id = auth('branch')->id();
        $attribute->save();

...
class AddonController extends Controller
{
    public function index(Request $request)
    {
        ...
        $addons = $addons->where('branch_id',auth('branch')->id())->orderBy('name')->paginate(Helpers::getPagination())->appends($query_param);
        return view('branch-views.addon.index', compact('addons', 'search'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $addon->branch_id = auth('branch')->id();
        $addon->save();
    ...
    public function edit($id)
    {
        ...
        return view('branch-views.addon.edit', compact('addon'));
    }

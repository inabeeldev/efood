...
class ReportController extends Controller
{
    ...
    public function earning_index(Request $request)
    {
        ...
        return view('branch-views.report.earning-index', compact('total_tax', 'total_sold', 'from', 'to'));
    }
    ...
    public function deliveryman_report()
    {
        ...
        return view('branch-views.report.driver-index', compact('orders'));
    }
...
//                    return response()->json('im 12132');
        ...
        return response()->json([
            ...
            'view' => view('branch-views.report.partials._table', compact('data'))->render(),
        ]);
    ...
    {
        return view('branch-views.report.sale-report');
    }

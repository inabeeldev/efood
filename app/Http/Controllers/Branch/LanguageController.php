...
class LanguageController extends Controller
{
    ...
    {
        return view('branch-views.business-settings.language.index');
    }

    public function store(Request $request)
    {
        $language = Helpers::get_branch_business_settings('language');
        if(!isset($language)) {
            DB::table('business_settings')->updateOrInsert(['key' => 'language','branch_id' => auth('branch')->id()], [
        ...
        BusinessSetting::updateOrInsert(['key' => 'language','branch_id' => auth('branch')->id()], [
            'value' => $lang_array,
            'branch_id' => auth('branch')->id()
        ]);
    ...
    public function update_status(Request $request)
    {
        ...
        $businessSetting = BusinessSetting::where(['key' =>  'language','branch_id' => auth('branch')->id()])->update([
            'value' => $lang_array,
            'branch_id' => auth('branch')->id()
        ]);
    ...
    public function update_default_status(Request $request)
    {
        ...
        BusinessSetting::where(['key' => 'language','branch_id' => auth('branch')->id()])->update([
            'value' => $lang_array,
            'branch_id' => auth('branch')->id()
        ]);
    ...
    public function translate($lang)
    {
        ...
        return view('branch-views.business-settings.language.translate', compact('lang', 'lang_data'));
    }

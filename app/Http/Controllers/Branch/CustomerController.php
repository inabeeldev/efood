...
class CustomerController extends Controller
{
    ...
    public function set_point_modal_data($id)
    {
        ...
        return response()->json([
            'view' => view('branch-views.customer.partials._add-point-modal-content', compact('customer'))->render()
        ]);
    }
    ...
    public function search(Request $request)
    {
        ...
        return response()->json([
            'view' => view('branch-views.customer.partials._table', compact('customers'))->render(),
        ]);
    }
    ...
    public function transaction(Request $request)
    {
        ...
        return view('branch-views.customer.transaction-table', compact('transition', 'search'));
    }
    ...
    public function excel_import()
    {
        $users = User::select('f_name as First Name',
            'l_name as Last Name', 'is_active as Active', 'point as Point')->get();

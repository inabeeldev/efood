...
Route::group(['namespace' => 'Branch', 'as' => 'branch.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::get('regitser-restaurant', 'LoginController@regitserForm')->name('register-form');
        Route::post('store-restaurant', 'LoginController@regsiterRestaurant')->name('store-restaurant');
    ...
    Route::group(['prefix' => 'reservation', 'as' => 'reservation.'], function () {
        ...
        Route::post('order-status/{id}', 'ReservationController@orderStatus')->name('order-status');
    ...
    Route::group(['middleware' => ['branch', 'branch_status']], function () {
        ...
        Route::get('membership', 'DashboardController@getMembership')->name('getMembership');
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.','middleware' => ['membership']], function () {
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware' => ['membership']], function () {

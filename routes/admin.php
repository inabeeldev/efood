...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'membership', 'as' => 'membership.', 'middleware' => ['module:user_management']], function () {
            Route::get('add-new', 'MembershipController@add_new')->name('add-new');
            Route::post('add-new', 'MembershipController@store');
            Route::get('list', 'MembershipController@list')->name('list');
            Route::get('update/{id}', 'MembershipController@edit')->name('update');
            Route::post('update/{id}', 'MembershipController@update');
            Route::delete('delete', 'MembershipController@delete')->name('delete');
        });

        Route::group(['prefix' => 'package', 'as' => 'package.', 'middleware' => ['module:user_management']], function () {
            ...
            Route::get('update/{id}', 'PackageController@edit')->name('update');
            Route::post('update/{id}', 'PackageController@update');
            Route::delete('delete', 'PackageController@delete')->name('delete');
        });

        Route::group(['prefix' => 'rpackage', 'as' => 'rpackage.', 'middleware' => ['module:user_management']], function () {
            Route::get('add-new', 'RestaurantPackageController@add_new')->name('add-new');
            Route::post('add-new', 'RestaurantPackageController@store');
            Route::get('list', 'RestaurantPackageController@list')->name('list');
            Route::get('update/{id}', 'RestaurantPackageController@edit')->name('update');
            Route::post('update/{id}', 'RestaurantPackageController@update');
            Route::delete('delete', 'RestaurantPackageController@delete')->name('delete');
        });

        Route::group(['prefix' => 'reservation', 'as' => 'reservation.', 'middleware' => ['module:user_management']], function () {
...
//        Route::post('/image-upload', 'FileManagerController@upload')->name('image-upload');
        ...
        Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.', 'middleware' => ['module:errand_management']], function () {
